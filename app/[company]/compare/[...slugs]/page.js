      ...
      <div style={{maxWidth:'1100px',margin:'0 auto'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'1.5rem',flexWrap:'wrap',gap:'10px'}}>
          <div style={{display:'flex',flexWrap:'wrap',gap:'6px',alignItems:'center'}}>
            <button onClick={()=>router.push(`/${company}`)} style={{fontSize:'13px',color:'#aaa',background:'transparent',border:'1px solid #ddd',padding:'5px 10px',borderRadius:'8px',cursor:'pointer',fontFamily:'Georgia,serif'}}>← Home</button>
            {names.map(n=>(
          ...
          <div style={{display:'flex',gap:'8px'}}>
            ...
            <button onClick={handleAnalyze} disabled={analyzing}
              ...
              {analyzing?'Analyzing...':'✦ Analyze with Claude in 30 seconds'}
            </button>
          </div>
        </div>
